...
function CssNormalQuestions() {
    ...
    useEffect(function () {
        const getVprasanja = async function () {
            const res = await fetch("http://83.212.82.61:42957/question/q/css/medium", { credentials: 'include' });
    ...
    return (
        ...
        <h1 class="display-2">CSS-Srednja Vprašanja</h1>
        </div>
        <br></br>
...
export default CssNormalQuestions;